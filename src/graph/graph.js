...
export default {
    ...
    addNode: function (name, node) {
        ...
        if (node.outputVal && (typeof (node.outputVal) === 'string' || typeof (node.outputVal) === 'number')) {
        ...
        if (node.outputVal && typeof (node.outputVal) === 'object') {
            ...
            observableOutput.observe(changes => {
                changes.forEach(change => {
                    console.log(change);
                    this.onOutputValChange(name, node);
        ...
        //Object.defineProperty(this.output, name, {value: node.outputVal, configurable:true, enumerable:true, writable:true })
    ...
    onOutputValChange: function (nodeName, node) {
        ...
        if (!node.isBeingTraversed) {
            ...
            this.output.dimensions = { ...node.outputVal };
